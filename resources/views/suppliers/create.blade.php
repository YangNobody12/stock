...
<head>
    ...
    <title>เพิ่มผู้จำหน่าย - ระบบจัดการสต็อก</title>

    <!-- นำเข้าฟอนต์ Prompt -->
    <link href="https://fonts.googleapis.com/css2?family=Prompt:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/supplier/stylesc.css') }}">
</head>
            ...
            <div class="card">
                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label>ชื่อผู้จำหน่าย <span class="required">*</span></label>
                        <input
                            type="text"
                            name="name"
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            name="address"
                            placeholder="กรอกที่อยู่แบบครบถ้วนของผู้จำหน่าย..."
