...
<head>
    ...
    <title>ผู้จำหน่ายสินค้า - ระบบจัดการสต็อก</title>

    <!-- นำเข้าฟอนต์ Prompt -->
    <link href="https://fonts.googleapis.com/css2?family=Prompt:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('css/supplier/stylesi.css') }}">
</head>
...
<div class="menu-label">เมนูหลัก</div>
    ...
    <main class="main-content">
        ...
        <div class="header">
            <h1>🚚 ผู้จำหน่ายสินค้า</h1>
            
            <div class="header-actions">
                <!-- ฟอร์มค้นหาผู้จำหน่าย -->
                <form action="{{ route('suppliers.index') }}" method="GET" class="search-box">
                    <input type="text" name="search" placeholder="ค้นหาชื่อผู้จำหน่าย..." value="{{ request('search') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <!-- ปุ่มลบ -->
                                        <form action="{{ route('suppliers.destroy', $supplier->id) }}" method="POST" onsubmit="return confirm('ยืนยันการลบผู้จำหน่ายรายนี้?');" style="margin: 0;">
                                            @csrf
                                            @method('DELETE')
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="empty-state">
                                        <div>📭</div>
                                        ยังไม่มีข้อมูลผู้จำหน่ายในระบบ
                                    </div>
                                </td>
                            </tr>
                        @endforelse
