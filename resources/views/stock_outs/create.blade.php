...
<head>
    ...
    <title>เพิ่มสินค้าออก - ระบบจัดการสต็อก</title>
...
<body>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="header">
                <h1>📤 เพิ่มสินค้าออก</h1>
                <a href="{{ route('stock_outs.index') }}" class="btn-cancel">
                    ← ย้อนกลับ
                </a>
            </div>
                ...
                <form action="{{ route('stock_outs.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="product_id" required>
                            <option value="">-- เลือกสินค้าที่ต้องการนำออก --</option>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label>จำนวนที่นำออก <span class="required">*</span></label>
                            <input
                                type="number"
                                name="quantity"
                                min="1"
                        ...
                        <div class="form-group">
                            <label>วันที่นำออก <span class="required">*</span></label>
                            <input
                                type="date"
                                name="date"
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            name="note"
                            placeholder="ระบุเหตุผลการนำออก หรือรายละเอียดเพิ่มเติม (ถ้ามี)..."
                        >{{ old('note') }}</textarea>
                    </div>
